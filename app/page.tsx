...
N:Klopper;Ruan;;;
ORG:Dynamic Coders
TEL;TYPE=CELL:+27 66 207 2937
EMAIL;TYPE=WORK:ruan@ruanklopper.com
END:VCARD`;
    ...
    link.href = url;
    link.download = "Ruan_Klopper.vcf";
    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative max-w-md mx-auto py-12 px-4 space-y-10">
        <div className="text-center space-y-4 animate-fade-in">
          ...
          <button
            onClick={saveContact}
            className="mx-auto mt-4 flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary via-chart-1 to-chart-3 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 active:scale-95"
          >
        ...
        >
          <div className="relative">
            ...
            <div className="relative flex justify-center">
              <h2 className="text-xl font-bold bg-background px-4 text-center">
                Get in Touch
              </h2>
            </div>
          </div>
